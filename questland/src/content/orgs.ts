...
// Rangers of Questia -> Valor (ruby), Hearers of the Alehiim -> Wilds (forest/green),
// Order of the Elm -> Lore (sapphire). Replaces the earlier provisional guess.

export const ORGS: Organization[] = [
  {
    id: 'rangers',
    name: 'Rangers of Questia',
  ...
  {
    id: 'elm',
    name: 'Order of the Elm',
    epithet: "Ellowyn's Sworn Company",
    sigil: '🌳',
    motto: 'Sworn in secret, faithful in the open.',
    description:
      'Founded on a single night of mischief by Princess Ellowyn and Able, the Order of the Elm keeps oaths that outgrow the games they started as. What began as a secret society is fast becoming Questia\'s quiet line of defense.',
    homeZoneId: 'st-21',
    track: 'lore',
    ...
    ranks: [
      ...
      { name: 'Sworn of the Elm', atEpisodes: 5 },
      { name: 'Guardian of the Elm', atEpisodes: 9 },
    ],
  },
]
